        ...
        <>
          <WhyUs />
            <div >
                ...
                <div className="sm:flex hidden items-center justify-between gap-5 md:gap-20 m-5 py-4">
                    <p className="md:text-xl">Dreamy Essence is a quiet little café with a big love for calm moments. We’ve kept our space intentionally clean and cozy — white walls, soft tones, and natural textures that let your thoughts settle. It’s a place where you can come as you are, and just be.</p>
